...
//    if (atsign < 1 || period < atsign + 2 || period + 2 >= x.length) {
//        alert("Not a fucking valid email!");
//        return false;
//    }
//    else {
//        return true;
...
//    return error;
//}
//  ----2nd try at validating -------
//return true;
//var resultArray = ["emailResult()", "passwordResult()"];
//
//var reason = "";
//reason += validateEmail(myForm.email);
//reason += validatePassword(myForm.password);
//reason += validateEmpty(myForm.form);
//
//if (reason != ""){
//    alert("some fields need correction" + reason);
//    return false;
//}
//---------everything about this is not important------------------

// FUNCTION VALIDATION WITHOUT ARRAY -----------------
...
//        document.getElementById('errPassword').innerHTML="not a valid password";
//        return false;
//        //var error = "";
//        //error = "password must be greater between 6-12 characters"
//    }
//        //return error;
//    return false;
//    }
...
//    alert("why'd you forget your password biiiitch?! ");
//}


// --------SECOND TRY WITH ARRAYS -------------
