...
exports.validatePasswordExistingUser = function (password) { // ----validate password function
    console.log("password validation:");
    if (!password) {
        return null
    }
...
exports.validateRepasswordExistingUser = function (repassword, password) { // ----validation re-password function
    console.log("RE-password validation:");
